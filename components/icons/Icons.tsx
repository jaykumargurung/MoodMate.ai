...
export const ChatBubbleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a.75.75 0 01-1.06 0l-3.72-3.72C9.347 17.653 8.5 16.689 8.5 15.555V11.27c0-.97.616-1.813 1.5-2.097m6.5-.024h-6.5a1.5 1.5 0 00-1.5 1.5v4.286c0 1.136.847 2.1 1.98 2.193l3.72 3.72a.75.75 0 001.06 0l3.72-3.72c1.133-.093 1.98-1.057 1.98-2.193V9.986c0-.828-.672-1.5-1.5-1.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 5.25a2.25 2.25 0 012.25-2.25h13.5a2.25 2.25 0 012.25 2.25v2.25a2.25 2.25 0 01-2.25 2.25h-4.591a1.5 1.5 0 00-.882.277l-1.518.91a.75.75 0 01-.882 0l-1.518-.91A1.5 1.5 0 005.84 9.75H5.25A2.25 2.25 0 013 7.5V5.25z" />
    </svg>
);
